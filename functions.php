<?php
/**
 * Noah Child functions and definitions
 *
...
function noah_child_overwrite_files() {
	...
	// See the parent's function.php -> the noah_scripts_styles() function
	// for details like resources names

		wp_dequeue_script( 'noah-main-scripts' );
	...
	// This is not required, but I assume you are not modifying that much :)
		...
		wp_enqueue_script( 'noah-child-scripts',
	...
	// see the parent's function.php -> the hive_scripts_styles() function for details like resources names
		...
		wp_dequeue_style( 'noah-main-style' );
...
// Load the files from the function mentioned above:
	...
	add_action( 'wp_enqueue_scripts', 'noah_child_overwrite_files', 11 );
